...
IGNORED_INDEX = -100
CustomLoss = HierarchicalCrossEntropyLoss(Ltree_iob2,LABELS_ID_LIST,Wtree_iob2,ignore_index=IGNORED_INDEX)
...
def save_dataset_bio(output_dir, datasets, names, suffix=None):
